...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,KC_EXLM,KC_AT, FR_LPRN,FR_RPRN ,KC_PIPE,KC_TRNS,
       KC_TRNS,KC_HASH,KC_DLR, FR_LBRC,FR_RBRC,KC_GRV,
       KC_TRNS,KC_PERC,KC_CIRC,FR_LCBR,FR_RCBR,KC_TILD,KC_TRNS,
